...
class Retriver():
    def __init__(self,config) -> None:
        self.build_retriver(config)
    def build_retriver(self,config):
        ...
        hf = HuggingFaceEmbeddings(model_name=config.model_name, model_kwargs=model_kwargs, encode_kwargs=encode_kwargs)
...
def main(args):
    ...
    # Perform similarity search using the quy
    query = args.query
